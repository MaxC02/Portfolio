...
namespace DigitalRuby.RainMaker
{
    public class RainScript : BaseRainScript
    {
        ...
        WeatherManager weatherManagerScript;
        ...
        private void UpdateRain()
        {
            ...
            if (weatherManagerScript.isRaining == true)
            {
                RainIntensity = 0f;
                WindSoundVolumeModifier = 0f;
            }

            if (weatherManagerScript.isRaining == false)
            {
                RainIntensity = 1.0f;
                WindSoundVolumeModifier = 0.5f;
            }
        ...
        protected override void Start()
        {
            ...
            weatherManagerScript = weatherManager.GetComponent<WeatherManager>();
